...
@implementation RecordeInfoItem
- (id)init{
    if (self = [super init]) {
        self.cellHeight = 90;
    }
...
@interface RecordeInfoCell()
{
}
@end

@implementation RecordeInfoCell
@dynamic item;
- (void)cellDidLoad
{
    [super cellDidLoad];
...
- (void)cellWillAppear
{
	...
	UILabel*chaoshiLab = [self createLabel:[NSString stringWithFormat:@"中奖时间 %@",StrRelay(self.item.userinfo[@"luckyTime"])] color:COLOR_999 font:Font_Size_12];
