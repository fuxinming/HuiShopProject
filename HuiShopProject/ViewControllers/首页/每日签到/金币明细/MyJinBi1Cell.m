...
@interface MyJinBi1Cell()
{
}
@end

@implementation MyJinBi1Cell
@dynamic item;
- (void)cellDidLoad
{
    [super cellDidLoad];
...
- (void)cellWillAppear
{
	...
	UILabel *t1Label = [self createLabel:@"金币可低现金，快去使用吧" color:COLOR_999 font:Font_Size_13];
